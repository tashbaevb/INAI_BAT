...
public class SecondHomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        textAnimator = new TextAnimator("\"Ошол күнү кечинде мен токойдо убакыт өткөрдүм, күндүн батышын тартууга аракет кылдым. Бул менин асманда жылдыздар ойгоно баштаган учурду сүрөткө тартуу аракетим болду. Бирок, тилекке каршы, менин көңүлүм толугу менен ишиме бурулуп, айланадан адаттан тыш же шектүү эч нерсе байкаган жокмун».\"",
                0.2, textOutput);
        textAnimator2 = new TextAnimator("\"Краузе мырзага келсек, биз көп сүйлөшчү эмеспиз, бирок аны менен болгон ар бир жолугушуу жагымдуу болду. Ал сүрөттөрү менен ойго салган таланттуу сүрөтчү экен. Бирок мен аны жеке таанычумун деп айта албайм.\"",
                0.2, textOutput);
        textAnimator3 = new TextAnimator("\"Эмма Шнайдерге келсек, ал, албетте, таланттуу соодагер, бирок биздин кызыкчылыктар башка. Мен анын дүкөнүнө бир нече жолу барсам да, антиквариат дүкөндөрүнө көп кирбейм. Эч кандай жагымсыз учурларыбыз болгон жок.\"",
                0.2, textOutput);
        textAnimator4 = new TextAnimator("\"Бирок менин Шмидт мырза менен бир аз көбүрөөк жалпылыгым бар. Мен китепканага көп барам, ал жерде айылдын өткөнү тууралуу кызыктуу окуяларды айтып берет. Ал билимдүү адам, анын аңгемелери ар дайым жаңы нерселерди алып келет.\"",
                0.2, textOutput);
