...
public class KgGameController2 {
    private KgPlayer player;
    private ParallaxBackground parallaxBackground;
    private Stage stage;

    public KgGameController2(Stage stage) {
        this.stage = stage;
    ...
    public static void startGame2() {
        ...
        KgGameController2 gameController2 = new KgGameController2(stage2);
    }
